...
interface TabelProps {
  items: Items[];
  setItems: React.Dispatch<React.SetStateAction<Items[]>>; // Tambahkan setItems prop untuk memperbarui daftar item
}

const Tabel: React.FC<TabelProps> = ({ items, setItems }) => {
            ...
            {items.map((item, key) => (
              <tr key={key}>
                ...
                <td className="border-b border-[#eee] py-5 px-4 pl-9 dark:border-strokedark xl:pl-11">
                  <h5 className="text-black dark:text-white">{item.nama}</h5>
                </td>
                <td className="border-b border-[#eee] py-5 px-4 dark:border-strokedark text-center">
                  <h5 className="text-black dark:text-white">{item.jumlah}</h5>
                </td>
                <td className="border-b border-[#eee] py-5 px-4 dark:border-strokedark text-center">
                  <h5 className="text-black dark:text-white">{item.tanggal}</h5>
                </td>
