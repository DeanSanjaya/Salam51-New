...
const Tabel = ({ items, setItems }) => {
  ...
  const handleDelete = async (_id) => {
    ...
    try {
      ...
      swalAlert('Item gagal dihapus', 'error');
    }
  };

  const handlePlus = (_id) => {
    navigate(`/barang/tambah-barang/${_id}`);
  };

  const handleDetail = (_id) => {
    navigate(`/barang/detail-barang/${_id}`);
  };
            ...
            {items.length === 0 ? (
              ...
              items.map((item, key) => (
                ...
                >
                  ...
                  <td className="border-b border-[#eee] py-5 px-4 dark:border-strokedark text-center">
                    <h5 className="text-black dark:text-white">{item.ROP}</h5>
                  </td>
                    ...
                    <div className="flex justify-center items-center space-x-3.5">
                      ...
                      >
                        <svg
                          ...
                          fill="none"
                        >
                          <rect x="8" y="2" width="2" height="14" fill="" />
                          <rect x="2" y="8" width="14" height="2" fill="" />
                        </svg>
                      </button>
                      {/* Tombol Detail */}
                      <button
