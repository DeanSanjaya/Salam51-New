...
const DetailBarang = () => {
  ...
  const handleDelete = async (detailId) => {
    try {
      const detailToDelete = item.detail.find(
        (detailItem) => detailItem._id === detailId,
      );

      const jumlahDihapus = detailToDelete.jumlah;
  ...
  return (
    <DefaultLayout>
      <Breadcrumb pageName={`Detail Barang ${item.nama}`} />
