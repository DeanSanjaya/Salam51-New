...
const SignIn = () => {
  ...
  const handleAuth = async (e) => {
    ...
    if (!username || !password) {
      loginFailed('Harap isi dengan lengkap');
      return;
    }
    try {
  ...
  return (
    <div className="h-screen pt-40 rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
